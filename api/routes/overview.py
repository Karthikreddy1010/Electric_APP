...
async def get_overview():
    ...
    tax_val = comp_subtotal * NJ_TAX_RATE
    ...
    prev_total_bill = prev_subtotal * (1.0 + NJ_TAX_RATE)
    ...
    primary_pct = (primary_val / latest_total_bill) * 100 if latest_total_bill > 0 else 0.0
