"""
SGLang Local Inference Provider.
High-throughput inference provider supporting OpenAI-compatible chat completions.
"""
import logging
import httpx
import json
...
class SGLangProvider(BaseLLMProvider):
    def __init__(self, model: Optional[str] = None, base_url: Optional[str] = None):
        ...
        url = base_url or llm_settings.sglang_base_url
    ...
    async def generate_stream(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise RuntimeError(f"SGLang stream failed: {e}")
